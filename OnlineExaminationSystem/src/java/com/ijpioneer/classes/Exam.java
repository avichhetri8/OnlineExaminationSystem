...
public class Exam {
    ...
    public Exam(int examId, String stdId,String cName, String tMarks, String obtMarks, String date, String startTime, String endTime, String examTime, String status) {
        this.examId = examId;
        this.stdId = stdId;
        this.cName=cName;
        this.tMarks = tMarks;
