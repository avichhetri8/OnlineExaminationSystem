package com.ijpioneer.database;
...
import com.ijpioneer.student.Student;
...
public class DatabaseClass {
    ...
    public void addNewStudent(String fName,String lName,String uName,String email,String pass,
            String contact,String city,String address,String user){
        try {
   ...
   public void insertAnswer(int eId,int qid,String question,String ans){
    ...
    public ArrayList getAllResultsFromExams(int stdId){
        ...
        try {
            ...
            ResultSet rs=pstm.executeQuery();
            while(rs.next()){
                exam=new Exam(rs.getInt(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5)
    ...
    public Exam getResultByExamId(int examId){
        Exam exam=null;
        try {
    ...
    public ArrayList getAllResultsFromExamsAll(){
        ArrayList list=new ArrayList();
        Exam exam=null;
        try {
